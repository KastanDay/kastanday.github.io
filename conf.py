...
BLOG_AUTHOR = "Kastan Day"  # (translatable)
BLOG_TITLE = "Tools for Thought"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://kastanday.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://kastanday.com/"
BLOG_EMAIL = "kastanvday@gmail.com"
BLOG_DESCRIPTION = "Designing tools for better thinking."  # (translatable)
...
THEME_CONFIG = {
    DEFAULT_LANG: {
        ...
        # This sidebar is visible on literally every page. Weird.
        'sidebar': ''
    }
}
